...
export default function AddPurchaseModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {<boltAction type="file" filePath="components/AddPurchaseModal.tsx">
'use client'
...
export default function AddPurchaseModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log({ itemName, amount, purchaseDate, category, notes });
    onClose();
  };
